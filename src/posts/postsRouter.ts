...
postsRouter
    ...
    .post("/", postDtoValidationMiddleware, inputValidationResultMiddleware, createPost)
    .put("/:id", idValidation, postDtoValidationMiddleware, inputValidationResultMiddleware, updatePostById)
    .delete("/:id", idValidation, inputValidationResultMiddleware, deletePostById)